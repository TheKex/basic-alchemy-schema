...
engine = db.create_engine("postgresql+psycopg2://postgres:3nwkNWPe@217.66.21.140/postgres")
...
insertion_query = products.insert().values([
    ...
    {'product_name': 'Tomatoes', 'supplier_name': 'United BTomatoes', 'price_per_tonne': 3100},
])
